...
PRODUCT_COPY_FILES += hardware/hardkernel/wifi/config/wpa_supplicant.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wpa_supplicant.conf

PRODUCT_COPY_FILES += hardware/hardkernel/wifi/config/init.odroid.wifi.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.odroid.wifi.rc
